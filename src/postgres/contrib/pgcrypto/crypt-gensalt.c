 ...
 */
static char *
yb_crypt_gensalt_sha(unsigned long count,
				   const char *input, int size, char *output, int output_size)
{
	char	   *s_ptr = output;
...
char *
yb_crypt_gensalt_sha512_rn(unsigned long count,
						 ...
						 char *output, int output_size)
{
	...
	return yb_crypt_gensalt_sha(count, input, size, output, output_size);
}

/* gen_list->gen function for sha256 */
char *
yb_crypt_gensalt_sha256_rn(unsigned long count,
