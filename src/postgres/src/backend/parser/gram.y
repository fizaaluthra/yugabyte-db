...
ConstraintElem:
			...
			/* TODO YB-PG19 check pg changes | PRIMARY KEY '(' columnList opt_without_overlaps ')' opt_c_include opt_definition OptConsTableSpace */
...
index_elem_options:
	opt_collate opt_qualified_name opt_yb_index_sort_order opt_nulls_order yb_opt_alias
		{
			$$ = makeNode(IndexElem);
			$$->name = NULL;
			$$->expr = NULL;
