...
/* YB: external pointers for spinlock/critical-section tracking (see spin.h, miscadmin.h) */
int		   *yb_spin_locks_acquired_ptr = NULL;
bool	   *yb_entered_critical_section_ptr = NULL;
...
InitProcess(void)
{
	...
	*/
	...
	/* YB: wire up external tracking pointers (see spin.h, miscadmin.h) */
	yb_spin_locks_acquired_ptr = &MyProc->ybSpinLocksAcquired;
	yb_entered_critical_section_ptr = &MyProc->ybEnteredCriticalSection;
...
ProcKill(int code, Datum arg)
{
	...
	/* YB: detach external tracking pointers */
	yb_spin_locks_acquired_ptr = NULL;
	yb_entered_critical_section_ptr = NULL;
