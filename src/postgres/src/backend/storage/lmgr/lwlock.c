...
#undef PG_LWLOCKTRANCHE
	/* YB-specific tranches */
	[LWTRANCHE_YB_ASH_CIRCULAR_BUFFER] = "YbAshCircularBuffer",
	[LWTRANCHE_YB_ASH_METADATA] = "YbAshMetadata",
	[LWTRANCHE_YB_QUERY_DIAGNOSTICS] = "YbQueryDiagnostics",
	[LWTRANCHE_YB_QUERY_DIAGNOSTICS_CIRCULAR_BUFFER] = "YbQueryDiagnosticsCircularBuffer",
	[LWTRANCHE_YB_TERMINATED_QUERIES] = "YbTerminatedQueries",
};
...
LWLockQueueSelf(LWLock *lock, LWLockMode mode)
{
	...
	/* YB: Use GetNumberFromPGProc instead of proc->backendId which was removed in PG19 */
