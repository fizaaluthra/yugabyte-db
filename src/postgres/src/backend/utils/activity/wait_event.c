...
/* YB_TODO_PG19_MERGE will the yb added stuff in these functions get auto generated? */
...
yb_wait_event_desc(PG_FUNCTION_ARGS)
{
	...
	/* for buffer pin (same as WAIT_EVENT_BUFFER_CLEANUP) */
	yb_insert_pg_events(PG_WAIT_BUFFER | WAIT_EVENT_BUFFER_CLEANUP, tupdesc, tupstore);
	...
	/* tuplestore_donestoring removed in PG19 */
