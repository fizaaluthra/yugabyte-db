			...
			switch (msgs[i].id)
			{
				...
				case SHAREDINVALSMGR_ID:	/* -3 */
					elog(DEBUG1, "msgs[%d]: id=%d yb_version=%d yb_sender_pid=%d "
						 "backend_hi=%d backend_lo=%u spcOid=%u dbOid=%u relNumber=%u\n",
						 i,
						 msgs[i].id,
...
YbCheckSharedInvalMessages()
{
	...
	static_assert(offsetof(SharedInvalSmgrMsg, backend_hi) == 1, "offset mismatch");
	static_assert(offsetof(SharedInvalSmgrMsg, backend_lo) == 2, "offset mismatch");
	static_assert(offsetof(SharedInvalSmgrMsg, rlocator) == 4, "offset mismatch");
	static_assert(offsetof(SharedInvalSmgrMsg, yb_version) == 16, "offset mismatch");
	static_assert(offsetof(SharedInvalSmgrMsg, yb_sender_pid) == 20, "offset mismatch");
