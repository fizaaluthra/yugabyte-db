...
/*
 * YB: _readYbExprColrefDesc and _readYbSkippableEntities are auto-generated
 ...
 *
 * _readYbUpdateAffectedEntities is kept as a custom_read_write implementation
 * because the struct has inline sub-structs that gen_node_support.pl cannot parse.
 */
...
/*
 * YB: _readYbSaopMergeInfo, _readYbSaopMergeSaopColInfo, _readYbSortInfo
