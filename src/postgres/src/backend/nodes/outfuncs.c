...
/* YB: _outYbBatchedExpr removed — now auto-generated by gen_node_support.pl. */
...
/*
 * YB: _outYbExprColrefDesc and _outYbSkippableEntities are auto-generated
 * by gen_node_support.pl.  YbExprColrefDesc lives in primnodes.h and
 * YbSkippableEntities in plannodes.h — both outside @nodetag_only_files.
 */
...
/*
 * YB: _outYbSaopMergeInfo, _outYbSaopMergeSaopColInfo, _outYbSortInfo
 * removed — now auto-generated by gen_node_support.pl.
 */
...
#include "outfuncs.switch.c"
			/*
			 * YB: Manual switch cases for YB types removed — now handled
			 * via auto-generated outfuncs.switch.c (custom_read_write for
			 * YbUpdateAffectedEntities, full auto-generation for the rest).
			 */
			default:
