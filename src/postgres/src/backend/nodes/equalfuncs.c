 ...
 *
 * YB: _equalYbBatchedExpr removed — now auto-generated by gen_node_support.pl.
 */
...
/*
 * YB: Equal functions for YbBackfillIndexStmt, YbBackfillInfo, YbRowBounds,
 * YbExprColrefDesc, and YbSkippableEntities are auto-generated by
 * gen_node_support.pl.  Their struct definitions live in header files outside
 * @nodetag_only_files (primnodes.h, plannodes.h, parsenodes.h).
 *
 * Only YbUpdateAffectedEntities needs a custom implementation due to inline
 * sub-structs that gen_node_support.pl cannot parse.
 */
...
#include "equalfuncs.switch.c"
		...
		/*
		 * YB: Manual switch cases for YbBackfillIndexStmt, YbBackfillInfo,
		 * YbRowBounds, YbExprColrefDesc, YbSkippableEntities, and
		 * YbUpdateAffectedEntities are now handled via auto-generated
		 * equalfuncs.switch.c (custom_copy_equal for YbUpdateAffectedEntities,
		 * full auto-generation for the rest).
		 */
