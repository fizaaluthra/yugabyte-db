...
/* YugabyteDB GUC hook declarations from commands/variable.h */
...
extern bool check_follower_read_staleness_ms(int *newval, void **extra, GucSource source);
extern void assign_follower_read_staleness_ms(int newval, void *extra);
extern const char *yb_fetch_effective_transaction_isolation_level(void);

/* YugabyteDB GUC variables defined in guc.c */
extern double yb_transaction_priority;
extern double yb_transaction_priority_lower_bound;
extern double yb_transaction_priority_upper_bound;
extern int yb_tcmalloc_sample_period;
extern char *yb_effective_transaction_isolation_level_string;
extern char *yb_xcluster_consistency_level_string;
extern char *yb_read_time_string;
extern char *yb_neg_catcache_ids_string;

/* YugabyteDB GUC hooks */
...
extern void assign_yb_enable_pg_stat_statements_rpc_stats(bool newval, void *extra);
extern void assign_yb_pg_batch_detection_mechanism(int new_value, void *extra);
extern void assign_yb_silence_advisory_locks_not_supported_error(bool newval, void *extra);
extern void assign_ysql_upgrade_mode(bool newval, void *extra);
extern bool check_default_replica_identity(char **newval, void **extra, GucSource source);
extern bool check_transaction_priority_lower_bound(double *newval, void **extra, GucSource source);
extern bool check_transaction_priority_upper_bound(double *newval, void **extra, GucSource source);
extern bool check_yb_disable_pg_snapshot_mgmt_in_repeatable_read(bool *newval, void **extra, GucSource source);
extern bool check_yb_enable_advisory_locks(bool *newval, void **extra, GucSource source);
extern bool check_yb_explicit_row_locking_batch_size(int *newval, void **extra, GucSource source);
extern const char *show_tcmalloc_sample_period(void);
extern bool yb_check_neg_catcache_ids(char **newval, void **extra, GucSource source);
extern bool yb_check_no_txn(int *newval, void **extra, GucSource source);
extern bool yb_check_toast_catcache_threshold(int *newval, void **extra, GucSource source);
extern bool yb_disable_auto_analyze_check_hook(bool *newval, void **extra, GucSource source);
extern void yb_set_neg_catcache_ids(const char *newval, void *extra);

/* YugabyteDB GUC enum option arrays */
extern const struct config_enum_entry yb_batch_detection_mechanism_options[];
extern const struct config_enum_entry yb_cost_model_options[];
extern const struct config_enum_entry yb_read_after_commit_visibility_options[];
extern const struct config_enum_entry yb_sampling_algorithm_options[];
